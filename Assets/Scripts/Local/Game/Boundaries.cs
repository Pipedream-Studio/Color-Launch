...
public class Boundaries : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            BoxCollider2D collider = valPair.Value.gameObject.AddComponent<BoxCollider2D>(); //Add our colliders. Remove the "2D", if you would like 3D colliders.
        ...
        //Tag the necessary colliders
        colliders["Bottom"].tag = "Fatal";
    }
}
